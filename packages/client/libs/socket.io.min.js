...
!(function (t, e) {
        ...
        return N && i instanceof Blob
          ...
          : B &&
            (i instanceof ArrayBuffer ||
              ((r = i),
              'function' == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer))
          ? e
            ? n(i)
            : L(new Blob([i]), n)
          : n(O[o] + (i || ''));
    ...
    ut = (function (n) {
      ...
      function a(n) {
        ...
        return (
          ...
          (r.port =
            i.port || ('undefined' != typeof location && location.port ? location.port : r.secure ? '443' : '80')),
                ...
                if ('string' == typeof t)
                  (e = this.decodeString(t)).type === bt.BINARY_EVENT || e.type === bt.BINARY_ACK
                    ? ((this.reconstructor = new Et(e)),
                      0 === e.attachments && f(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e))
                  ...
                  (e = this.reconstructor.takeBinaryData(t)) &&
                    ((this.reconstructor = null), f(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e));
                }
              },
            },
            {
  ...
  return (
    o(xt, { Manager: Nt, Socket: Ot, io: xt, connect: xt }), 'undefined' != typeof module && (module.exports = xt), xt
  );
});
